#!/usr/bin/perl -w
#
# $FreeBSD: CVSROOT-src/commit_prep.pl,v 1.65 2002/08/31 06:07:42 jmallett Exp $
#
#
...
#		return(1);
	...
	if ($rname ne "$directory/$filename,v") {
		...
		# (eg: somebody sent in a port with $Id: commit_prep.pl,v 1.1 2003/08/14 10:00:53 jiangxin Exp $ and the
